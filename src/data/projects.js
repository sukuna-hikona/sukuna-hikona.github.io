export const projects = [
  {
    ...
    summary: '企業・組織のセキュリティ担当者向けの脆弱性管理SaaS。NVD・MyJVN・GitHub Advisoryから脆弱性情報を自動収集・マッチングし、リアルタイム通知。チェックリスト診断によるセキュリティスコア算出、Stripe連携のサブスクリプション課金に対応。',
    status: '開発中',
    detail: {
      challenges: [
        '自社サーバ・ソフトウェアに関連する脆弱性を見逃すリスク',
        'セキュリティ対策状況の可視化・定量評価が困難',
        '脆弱性情報の多言語対応（英語→日本語翻訳）'
      ],
      solution: '監視対象のサーバ/ソフトウェアを登録するだけで、関連する脆弱性情報を自動収集・マッチングし、リアルタイムで通知。チェックリスト診断によりセキュリティスコアを算出し、対策状況を可視化します。',
      techStack: {
  ...
  },
  {
    ...
    detail: {
      ...
      highlights: [
        '浮動小数点誤差を排除した高精度金額計算（Decimal.js + Brick Money）',
